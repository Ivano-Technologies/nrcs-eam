    ...
    items: [
      {
        ...
        path: appPath("/finance/cost-management"),
        icon: BarChart3,
        managerOrAdminOnly: true,
      },
      {
        label: "Depreciation Reporting",
        path: appPath("/finance/depreciation"),
        icon: TrendingDown,
        managerOrAdminOnly: true,
      },
  ...
  },
  {
    ...
    items: [
      { label: "Compliance", path: appPath("/compliance"), icon: ShieldCheck },
      {
        ...
        path: appPath("/compliance/insurance"),
        icon: Shield,
        managerOrAdminOnly: true,
      },
    ],
...
export const SIDEBAR_GROUPS_ADMIN: AppNavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Audit Trail", path: appPath("/audit-trail"), icon: FileText },
...
const GROUP_PREFIXES: { groupId: string; pathPrefix: string }[] = [
  ...
  { groupId: "assets", pathPrefix: appPath("/finance/asset-valuation") },
  ...
  { groupId: "finance", pathPrefix: appPath("/finance/cost-management") },
  { groupId: "finance", pathPrefix: appPath("/finance/depreciation") },
  ...
  { groupId: "administration", pathPrefix: appPath("/audit-trail") },
